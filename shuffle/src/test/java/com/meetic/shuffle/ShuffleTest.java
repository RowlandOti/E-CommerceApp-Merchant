...
public class ShuffleTest {
    ...
    @Test
    public void testOnViewInflated() {
        //Given
    ...
    @Test
    public void testGetViewHolderListForType() {
    }

    @Test
    public void testGetNextUnusedViewHolder() {
        //Given
    ...
    @Test
    public void testGetNextUnusedViewHolder_isNull() {
        //Given
        List<Shuffle.ViewHolder> viewHolderList = Arrays.asList(
                mockShuffleViewHolder(1),
                mockShuffleViewHolder(2),
    ...
    @Test
    @Ignore
    public void testUpdateDraggableViews() {

    }

    @Test
    public void testUpdateAdapter_firstTime() {
        //Given
        given(shuffleSettings.getNumberOfDisplayedCards()).willReturn(3);
    ...
    @Test
    public void testSetFirstCardDraggable() {
        //Given
        CardDraggableView draggableView1 = mockDraggableView();
        CardDraggableView draggableView2 = mockDraggableView();
        CardDraggableView draggableView3 = mockDraggableView();
    ...
    @Test
    public void testMoveFirstCardToStack() {
        //Give
